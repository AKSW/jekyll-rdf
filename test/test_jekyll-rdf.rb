...
class TestJekyllRdf < Test::Unit::TestCase
  ...
  site.process
  pagearray = site.pages.select{|p| p.name == "www/ifi/uio/no/INF3580/simpsons#Homer/index.html"} # creates an array
  ...
  context "Generating a site with RDF data" do
    should "create a file which mentions 'Lisa Simpson'" do
      s = File.read("#{TestHelper::DEST_DIR}/rdfsites/www/ifi/uio/no/INF3580/simpsons#Lisa/index.html") # read static file
