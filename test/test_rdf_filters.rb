...
class TestRdfFilter < Test::Unit::TestCase
  ...
  graph = RDF::Graph.load(File.join(File.dirname(__FILE__), "cases/filter/_data/knowledge-base.ttl"))
  sparql = SPARQL::Client.new(graph)
  prefix_path = File.join(File.dirname(__FILE__), "cases/filter/_data/Prefixes.pref")
